    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('collector', 'Collector'), ('grower', 'Grower'), ('admin', 'Admin')], default='collector', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('variant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='images', to='core.productvariant')),
            ],
            options={
                'ordering': ['order'],
            },
